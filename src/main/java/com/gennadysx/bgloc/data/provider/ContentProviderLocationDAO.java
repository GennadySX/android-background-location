package com.gennadysx.bgloc.data.provider;
...
import com.gennadysx.bgloc.data.sqlite.SQLiteLocationContract;
...
public class ContentProviderLocationDAO implements LocationDAO {
    ...
    public BackgroundLocation getFirstUnpostedLocation() {
        ...
        substmt = com.gennadysx.utils.TextUtils.removeLastChar(substmt, ";");
