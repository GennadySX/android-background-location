package com.gennadysx.geolocation.bgloc.data.provider;
...
import com.gennadysx.geolocation.bgloc.data.sqlite.SQLiteLocationContract.LocationEntry;
...
public class ContentProviderLocationDAO implements LocationDAO {
    ...
    public BackgroundLocation getFirstUnpostedLocation() {
        ...
        substmt = com.gennadysx.geolocation.utils.TextUtils.removeLastChar(substmt, ";");
