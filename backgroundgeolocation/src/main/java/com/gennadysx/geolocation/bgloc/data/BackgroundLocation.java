...
import com.gennadysx.geolocation.bgloc.data.sqlite.SQLiteLocationContract;
...
public class BackgroundLocation implements Parcelable {
    ...
    public static BackgroundLocation fromCursor(Cursor c) {
        ...
        l.setProvider(c.getString(c.getColumnIndex(SQLiteLocationContract.LocationEntry.COLUMN_NAME_PROVIDER)));
    ...
    public ContentValues toContentValues() {
        ...
        values.put(SQLiteLocationContract.LocationEntry.COLUMN_NAME_TIME, time);
        values.put(SQLiteLocationContract.LocationEntry.COLUMN_NAME_ACCURACY, accuracy);
        values.put(SQLiteLocationContract.LocationEntry.COLUMN_NAME_SPEED, speed);
        values.put(SQLiteLocationContract.LocationEntry.COLUMN_NAME_BEARING, bearing);
        values.put(SQLiteLocationContract.LocationEntry.COLUMN_NAME_ALTITUDE, altitude);
        values.put(SQLiteLocationContract.LocationEntry.COLUMN_NAME_LATITUDE, latitude);
        values.put(SQLiteLocationContract.LocationEntry.COLUMN_NAME_LONGITUDE, longitude);
        values.put(SQLiteLocationContract.LocationEntry.COLUMN_NAME_RADIUS, radius);
        values.put(SQLiteLocationContract.LocationEntry.COLUMN_NAME_HAS_ACCURACY, hasAccuracy);
        values.put(SQLiteLocationContract.LocationEntry.COLUMN_NAME_HAS_SPEED, hasSpeed);
        values.put(SQLiteLocationContract.LocationEntry.COLUMN_NAME_HAS_BEARING, hasBearing);
        values.put(SQLiteLocationContract.LocationEntry.COLUMN_NAME_HAS_ALTITUDE, hasAltitude);
        values.put(SQLiteLocationContract.LocationEntry.COLUMN_NAME_HAS_RADIUS, hasRadius);
        values.put(SQLiteLocationContract.LocationEntry.COLUMN_NAME_PROVIDER, provider);
        values.put(SQLiteLocationContract.LocationEntry.COLUMN_NAME_LOCATION_PROVIDER, locationProvider);
        values.put(SQLiteLocationContract.LocationEntry.COLUMN_NAME_STATUS, status);
        values.put(SQLiteLocationContract.LocationEntry.COLUMN_NAME_BATCH_START_MILLIS, batchStartMillis);
        values.put(SQLiteLocationContract.LocationEntry.COLUMN_NAME_MOCK_FLAGS, mockFlags);
        return values;
    }
